// components/dashboard/user/rules/recommendedRules/RecommendedRules.tsx
'use client';
            ...
            {state.recommendations.map((recommendation) => (
              ...
              >
                <RecommendationCard
                  ...
                  onEdit={() => {
                    actions.setEditingId(recommendation.id);
                    actions.setEditingRule(recommendation);
                  }}
                  onSave={(updates) => {
                    actions.updateRecommendation(recommendation.id, updates);
                    actions.setEditingId(null);
                    actions.setEditingRule(null);
                  }}
                  onCancel={() => {
                    actions.setEditingId(null);
                    actions.setEditingRule(null);
